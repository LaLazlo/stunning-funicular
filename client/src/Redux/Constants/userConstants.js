...
export const GET_ASSIGNED_MEJ_REQUEST = "GET_ASSIGNED_MEJ_REQUEST";
export const GET_ASSIGNED_MEJ_SUCCESS = "GET_ASSIGNED_MEJ_SUCCESS";
export const GET_ASSIGNED_MEJ_FAIL = "GET_ASSIGNED_MEJ_FAIL";
export const GET_ASSIGNED_MEJ_RESET = "GET_ASSIGNED_MEJ_RESET";

export const DELETE_ASSIGNED_MEJ_REQUEST = "DELETE_ASSIGNED_MEJ_REQUEST";
export const DELETE_ASSIGNED_MEJ_SUCCESS = "DELETE_ASSIGNED_MEJ_SUCCESS";
export const DELETE_ASSIGNED_MEJ_FAIL = "DELETE_ASSIGNED_MEJ_FAIL";
export const DELETE_ASSIGNED_MEJ_RESET = "DELETE_ASSIGNED_MEJ_RESET";
